...
private:
  double cycle_;                         // 制御周期
  const static double kp_[2];            // 比例ゲイン
  const static double ki_[2];            // 積分ゲイン
  const static double kd_[2];            // 微分ゲイン
  ...
  const static double min_acceleration_;
  const static double reach_speed_;
